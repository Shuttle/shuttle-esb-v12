...
<template>
    <section id="hero">
        <p class="documentation-redirect">
            This documentation relates to Shuttle.Esb before v13.0.0 was released.  You may wish to view the <a href="https://shuttle.github.io/shuttle-esb/">latest documentation</a>.
        </p>
...
.documentation-redirect {
    margin: 0 auto 2em;
    border: 1px solid rgb(74, 102, 71);
    width: fit-content;
    padding: 1.5em;
    border-radius: .5em;
    background-color: rgb(36, 44, 34);
}
